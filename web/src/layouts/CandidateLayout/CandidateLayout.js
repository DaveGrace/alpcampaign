...
import david from 'src/pages/DavidPage/DavidPortrait.jpg'
          ...
          <div className="space-y-10">
            <div className="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
              <h2 className="text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl">
                Meet our Country Labor Eurobodalla Council Team
              </h2>
              <p className="text-xl leading-7 text-white-500">
            ...
            <ul className="mx-auto space-y-16 sm:grid sm:grid-cols-2 sm:gap-16 sm:space-y-0 lg:grid-cols-5 lg:max-w-5xl">
              <li>
                ...
                <a href="#"className="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">
